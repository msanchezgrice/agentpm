...
INSERT INTO agents (id, user_id, name, strategy_type, initial_capital, current_capital, total_return_pct, created_at) VALUES
    ('momentum-master-001', 'demo-user-001', 'Momentum Master', 'momentum', 100000, 132000, 32.0, NOW() - INTERVAL '6 months'),
    ('value-hunter-001', 'demo-user-001', 'Value Hunter', 'value', 100000, 118000, 18.0, NOW() - INTERVAL '6 months')
