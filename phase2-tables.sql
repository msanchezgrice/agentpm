-- Phase 2: Custom Strategy Builder Tables
-- Run this SQL in Supabase to add the required tables for the agent creation wizard

-- 1. Create agent_configurations table for storing detailed agent settings
...
-- 2. Create backtest_jobs table for tracking backtesting tasks
